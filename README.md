...
False
```
Note that the functions `true` and `false` exist in the Base
# FScript
* [1 Introduction](#1)
    * [1.1 The commandline interface](#1.1)
    * [1.2 Basic Syntax](#1.2)
...
"Hello, World!"
```
Just like Haskell, FScript does not have a dedicated type for strings. Instead strings are jsut represented as
